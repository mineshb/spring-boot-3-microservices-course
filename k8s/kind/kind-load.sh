...
docker pull mineshdev/api-gateway:latest
docker pull mineshdev/product-service:latest
docker pull mineshdev/order-service:latest
docker pull mineshdev/inventory-service:latest
docker pull mineshdev/notification-service:latest
...
kind load docker-image -n microservices mineshdev/api-gateway:latest
kind load docker-image -n microservices mineshdev/product-service:latest
kind load docker-image -n microservices mineshdev/order-service:latest
kind load docker-image -n microservices mineshdev/inventory-service:latest
kind load docker-image -n microservices mineshdev/notification-service:latest
